...
const Hero = () => {
  return (
    <div>
            ...
            <div style={{marginTop:"100px"}} className=' bg-gradient-to-tr from-black-600 to-red-900 bg-slate-500  h-96 w-[80%]  bg-center mx-auto rounded-2xl  box-border relative'>
                {/* background image */}
